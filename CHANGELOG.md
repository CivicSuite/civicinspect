...
- Added default local SQLite persistence for bare installs, staff workspace UI at `/civicinspect/staff`, and suite integration contracts for inspection draft, staff review queue, and records export checklist handoffs.
