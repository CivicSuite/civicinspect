...
exec((root / "civicinspect" / "__init__.py").read_text(encoding="utf-8"), namespace)
...
dist = Path("dist")
wheel = dist / "civicinspect-0.1.1-py3-none-any.whl"
sdist = dist / "civicinspect-0.1.1.tar.gz"
