...
Local gate status: GREEN for local source release checks.

No remote release verdict is claimed until PR, merge, tag, release, suite-truth reconciliation, and CI evidence are complete.
...
| CivicCore dependency | Pass | published CivicCore v1.1.0 release wheel in `pyproject.toml` |
...
| UX/browser | Pass | desktop/mobile public UI and docs screenshots, zero console/page errors, no overflow, focus evidence, and loading/success/empty/error/partial state evidence |
