...
Current state: CivicInspect v0.2.1 corrective demotion state candidate for the active release run. This repo provides a FastAPI package aligned to the CivicCore v1.1.0 release wheel, deterministic and database-backed repeat-case lookup, persisted report-draft records, staff-only review queue workflows, review-required inspection context packets, adversarial local integration mocks, notice draft support, records-ready export checklists, and accessible public sample UI at /civicinspect.
