...
Current state: published v1.0.0 label in active recovery/productization work. This repo provides a FastAPI package aligned to the CivicCore v1.0.0 release wheel, deterministic and database-backed repeat-case lookup, persisted report-draft records, staff-only review queue workflows, review-required inspection context packets, adversarial local integration mocks, notice draft support, records-ready export checklists, and accessible public sample UI at /civicinspect.
