...
Current state: CivicInspect v1.0.0 public-use module release candidate for the active release run. This repo provides a FastAPI package aligned to the CivicCore v1.1.0 release wheel, deterministic and database-backed repeat-case lookup, persisted report-draft records, staff-only review queue workflows, review-required inspection context packets, adversarial local integration mocks, notice draft support, records-ready export checklists, and accessible public sample UI at /civicinspect.
